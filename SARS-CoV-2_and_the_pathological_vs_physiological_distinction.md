...
If a country is pursuing a goal of containment (the US is not, although we like to incur all the negatives of trying to do so anyway), it makes sense to track the incidence of SARS-2 itself beyond merely tracking disease states: fine. Additionally, even in a country that isn't practicing containment (and most countries aren't), it's cool to be able to track the spread of the virus itself. That's fine. But it needs to be reported as a separate metric, not conflated (perhaps intentionally) with the disease state, which serves to drum up unnecessary fear and ultimately will lead to worsened health outcomes. Frightening people unnecessarily is bad, and it leads to them making irrational decisions that end up harming their health. It's not directly related to the fundamentally flawed COVID-19 case definition, but one of my "favorite" (in the tragic sense) papers is the following case report of 5 individuals, ["Large-Vessel Stroke as a Presenting Feature of Covid-19 in the Young"](https://www.nejm.org/doi/full/10.1056/NEJMc2009787), which notes that "social distancing, isolation, and reluctance to present to the hospital may contribute to poor outcomes. Two patients in our series delayed calling an ambulance because they were concerned about going to a hospital during the pandemic." In this case report, people who genuinely had COVID-19, who indeed experienced strokes that were at least related if not directly attributable to COVID-19, *were too afraid to go to the hospital because they were scared to catch COVID-19*. There's some room for interpretation, but my personal read on it is that they had been so terrified by a media and public health establishment that has divorced discussion of COVID-19 from any rational assessment of risk, that they didn't realize they had COVID-19 because COVID-19 was portrayed to them as even worse and scarier than the actual sickness they experienced. [TODO Note: I might axe this whole discussion of this case report entirely, or I might just axe my interpretation at the end, or I might leave it all]

### The germ theory of disease has ruined us

The germ theory of disease has completely ruined us. Or, more accurately, the germ theory itself is fine, but the widespread misunderstanding of what the germ theory actually means has led to incalculable harm, both historically and presently.

### The miasma theory of disease

Let's take a brief detour to talk about a historical folk theory

### PCR

PCR, or polymerase chain reaction, is a method of exponentially amplifying specific subsections of DNA in a sample (via input of "primers") in order to detect the presence of a sequence of DNA. In the context of COVID-19, it's used to identify RNA associated with the SARS-CoV-2 virus.
...
Both the long-tail false positives and the true false positives are why we need to define COVID-19 cases the way we define any other disease. It's possible to have HIV without having AIDS. Similarly, it's possible to have SARS-CoV-2 *without any associated disease*; but the way we currently define it that's actually not possible. Again, because a positive PCR result alone is all that's required to label somebody a COVID-19 case, we end up with almost a completely meaningless case definition. Not only does this perpetuate the environment of fear and hysteria, but it also makes cases in their current form a completely absurd metric.
